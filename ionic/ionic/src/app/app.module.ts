...
@NgModule({
  ...
  imports: [
    ...
    IncomeAllPageModule,OutcomeAllPageModule,
    EditDataIncomePageModule,EditDataOutcomePageModule,
    InsertIncomePageModule,InsertOutcomePageModule,
    ShowDataIncomePageModule,ShowDataOutcomePageModule,
    ProfilePageModule,EditProfliePageModule
